...
public class RunIterator implements Iterator {
   ...
   */
    private DListNode itRed;
    private DListNode itBlue;
    private DListNode itGreen;
    private DListNode fHead;
  ...
  // the encoding.
  RunIterator(DListNode red, DListNode blue, DListNode green) {
      fHead = red;
      itRed = red.next;
      itBlue = blue.next;
      itGreen = green.next;
  ...
  public int[] next() {
    ...
    // call to next() will return the subsequent run.
      ...
      if (this.hasNext()) {
          result[0] = itRed.num;
          result[1] = itRed.item;
          result[2] = itGreen.item;
          result[3] = itBlue.item;
          itRed = itRed.next;
          itBlue = itBlue.next;
          itGreen = itGreen.next;
          return result;
      } else {
